...
프로젝트 루트에 `.env` 파일을 생성하고 아래 내용을 작성
...
|--------|------|
| `main` | 배포용 브랜치. 직접 커밋X |
| `dev` | 개발 통합 브랜치. 기능 개발 완료 후 여기에 머지 |
| `feat/기능명` | 기능 개발 |
| `fix/버그명` | 버그 수정 |
| `refactor/명칭` | 코드 개선 |
...
```
1. dev 브랜치에서 feature 브랜치를 생성
2. 작업 완료 후 dev 브랜치로 PR을 작성
3. 코드 리뷰 후 dev에 머지
4. 배포 시 dev → main으로 머지
```
